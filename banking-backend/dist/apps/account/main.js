...
let AccountService = class AccountService {
    ...
    async createAccount(userId, accountNumber, balance) {
    ...
    async updateAccountBalanceGrpc(accountNumber, amount, type) {
